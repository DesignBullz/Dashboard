...
//   const sheetURL =
//     "https://docs.google.com/spreadsheets/d/1Qy-LAaYDEGxuKBymSPFXynL99YfFn6yTW-cd_Bz5DaY/export?format=csv&id=1Qy-LAaYDEGxuKBymSPFXynL99YfFn6yTW-cd_Bz5DaY&gid=1468133613"; // Your Google Sheet CSV URL for the last 30 days
...
//         // Calculate POC Averages (number of orders per POC) for the last 30 days
//         const pocOrderCount = {};
...
//         // Calculate Total Average (orders per day) for the last 30 days
...
//           POC Orders and Averages (Last 30 Days)
//         </h1>

//         {/* Total Average */}
//         <div className="bg-blue-50 p-6 rounded-lg shadow-md">
//           <h2 className="text-xl font-semibold text-gray-800">
//             Total Orders Average (Last 30 Days)
//           </h2>
...
//           <h2 className="text-xl font-semibold text-gray-800">
//             POC Orders Average (Last 30 Days)
//           </h2>
...
import React, { useEffect, useState } from "react";
import * as Papa from "papaparse";
import { FaSpinner, FaChartLine, FaUsers } from "react-icons/fa";
...
const Last30Days = () => {
  ...
  const sheetURL =
    "https://docs.google.com/spreadsheets/d/1Qy-LAaYDEGxuKBymSPFXynL99YfFn6yTW-cd_Bz5DaY/export?format=csv&id=1Qy-LAaYDEGxuKBymSPFXynL99YfFn6yTW-cd_Bz5DaY&gid=1468133613";
  ...
  useEffect(() => {
    fetch(sheetURL)
      ...
      .then((csvText) => {
        const parsedData = Papa.parse(csvText, { header: true }); // Parse CSV to JSON
        setData(parsedData.data); // Store parsed data
      ...
      {loading ? (
        ...
        <div className="max-w-4xl w-full p-8 bg-white rounded-lg shadow-lg space-y-8">
          <h1 className="text-3xl font-bold text-center text-gray-800 flex items-center justify-center">
            <FaChartLine className="text-blue-500 mr-3" /> POC Orders and
