...
//   const sheetURL =
//     "https://docs.google.com/spreadsheets/d/1Qy-LAaYDEGxuKBymSPFXynL99YfFn6yTW-cd_Bz5DaY/export?format=csv&id=1Qy-LAaYDEGxuKBymSPFXynL99YfFn6yTW-cd_Bz5DaY&gid=1824590062";
//   useEffect(() => {
//     fetch(sheetURL)
...
//           POC Orders and Averages
//         </h1>

//         {/* Total Average */}
//         <div className="bg-blue-50 p-6 rounded-lg shadow-md">
//           <h2 className="text-xl font-semibold text-gray-800">
//             Total Orders Average (Last Days)
//           </h2>
...
const SevenDays = () => {
  ...
  const [totalAverage, setTotalAverage] = useState(0); // Total average orders
      ...
      {loading ? (
        ...
        <div className="max-w-4xl w-full p-8 bg-white rounded-lg shadow-lg space-y-8">
          ...
          <div className="flex items-center bg-blue-50 p-6 rounded-lg shadow-md">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-800">
                Total Orders Average (Last 7 Days)
              </h2>
              <p className="text-2xl text-gray-700">{totalAverage}</p>
            </div>
          </div>
